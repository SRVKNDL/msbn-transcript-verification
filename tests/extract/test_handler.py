"""Smoke tests for ExtractLambda.

Verifies importability and stub response shape. No PDF rendering or Bedrock
...
def test_handler_returns_200(step_functions_event, lambda_context):
    """Handler must return HTTP 200 for a Step Functions extraction event."""
